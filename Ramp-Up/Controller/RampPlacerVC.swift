...
// Include UIPopoverPresentationControllerDelegate to add popover effect when a new RampPickerVC is created
...
*/
    ...
    // Tell the RampPickerVC to follow our guidelines for setting the VC size
    func adaptivePresentationStyle(for controller: UIPresentationController) -> UIModalPresentationStyle {
        return .none
    }
    
    // Create and display a view for the RampPickerVC upon the press of this button
